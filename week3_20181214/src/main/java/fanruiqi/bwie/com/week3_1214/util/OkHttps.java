package fanruiqi.bwie.com.week3_1214.util;
...
public class OkHttps {
    ...
    public void doPost(String url, Map<String,Integer> map,final OnCallBack onCallBack){  //POST

        FormBody.Builder builder = new FormBody.Builder();

        for (String k:map.keySet()){
            builder.add(k, String.valueOf(map.get(k)));
        }
